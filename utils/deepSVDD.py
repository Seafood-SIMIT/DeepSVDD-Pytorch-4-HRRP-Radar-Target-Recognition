...
from model.network import DeepSVDDNetwork
...
class DeepSVDD(object):
    ...
    def train(self, trainloader, optimizer_name: str = 'adam', lr: float = 0.001, n_epochs: int = 50,
    ...
    def pretrain(self, trainloader,testloader, optimizer_name: str = 'adam', lr: float = 0.001, n_epochs: int = 100,
                 lr_milestones: tuple = (), batch_size: int = 128, weight_decay: float = 1e-6, device: str = 'cuda',
                 n_jobs_dataloader: int = 0):
        ...
        self.ae_net = self.ae_trainer.train(trainloader, self.ae_net)
        self.ae_trainer.test(testloader, self.ae_net)
